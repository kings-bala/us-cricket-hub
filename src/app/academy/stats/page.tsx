...
const subLinks = [
  ...
  { href: "/combine", label: "Combine", color: "purple", desc: "Athletic testing & assessments" },
];
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          <h1 className="text-3xl font-bold text-white">My Academy Stats</h1>
        </div>
        <p className="text-slate-400">
          Track your academy players&apos; performance, rankings, and combine assessments.
        </p>
      </div>
