    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {tab === "training" && (() => {
        ...
        const DRILL_LIBRARY = [
          ...
          { id: "b7", title: "Back Foot Drive Tutorial", description: "Complete guide on playing the back foot drive with proper weight transfer and punch technique.", category: "batting" as const, skill: "Back Foot", level: "intermediate" as const, duration: "4 min", videoUrl: "https://www.youtube.com/watch?v=pERHJeijBXw", channel: "Cricket Mentoring" },
          ...
          { id: "w1", title: "Fast Bowling Masterclass", description: "Complete fast bowling tutorial covering run-up, action, and release point from professional coaches.", category: "bowling" as const, skill: "Run-Up", level: "beginner" as const, duration: "12 min", videoUrl: "https://www.youtube.com/watch?v=SH3vf2JsBVE", channel: "Cricket Mentoring" },
          { id: "w2", title: "Bowling Arm Action Drills", description: "Drills to maintain a legal bowling action, maximize arm speed and prevent elbow flex issues.", category: "bowling" as const, skill: "Arm Action", level: "intermediate" as const, duration: "8 min", videoUrl: "https://www.youtube.com/watch?v=oa_wN1JqlKA", channel: "CoachCricXI" },
          { id: "w3", title: "Spin Bowling: Leg Spin Basics", description: "Learn leg spin fundamentals including grip, wrist position, release and flight control.", category: "bowling" as const, skill: "Spin", level: "beginner" as const, duration: "10 min", videoUrl: "https://www.youtube.com/watch?v=aCfjGQ6jxog", channel: "Cricket Mentoring" },
          { id: "w4", title: "Yorker Bowling Drill", description: "Target-based yorker practice methods to improve death bowling accuracy under pressure.", category: "bowling" as const, skill: "Yorker", level: "advanced" as const, duration: "6 min", videoUrl: "https://www.youtube.com/watch?v=r8R1QqjpXJE", channel: "CoachCricXI" },
          ...
          { id: "x1", title: "Cricket-Specific Warm-Up Routine", description: "Dynamic warm-up routine targeting muscles used in cricket — shoulders, hips, legs, and core.", category: "fitness" as const, skill: "Warm-Up", level: "beginner" as const, duration: "10 min", videoUrl: "https://www.youtube.com/watch?v=GkajjTmXeu0", channel: "Cricket Life Stories" },
          { id: "x2", title: "Fast Bowler Strength Program", description: "Gym exercises for fast bowlers focusing on core stability, shoulder strength and injury prevention.", category: "fitness" as const, skill: "Strength", level: "intermediate" as const, duration: "10 min", videoUrl: "https://www.youtube.com/watch?v=af5viX8O0k4", channel: "Cricket My Words" },
          { id: "x3", title: "Agility & Reaction Speed Drills", description: "Improve fielding reflexes, lateral movement speed, and reaction time with cone and ball drills.", category: "fitness" as const, skill: "Agility", level: "intermediate" as const, duration: "5 min", videoUrl: "https://www.youtube.com/watch?v=YLS1GoBdtvk", channel: "Rajasthan Royals Academy" },
        ];
