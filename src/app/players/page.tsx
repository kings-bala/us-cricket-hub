    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {tab === "training" && (() => {
        ...
        const DRILL_LIBRARY = [
          ...
          { id: "b7", title: "Back Foot Play & Punch Technique", description: "Complete guide on playing off the back foot — cuts, pulls, and back foot punches against short bowling.", category: "batting" as const, skill: "Back Foot", level: "intermediate" as const, duration: "9 min", videoUrl: "https://www.youtube.com/watch?v=f4QBb2eIVbk", channel: "CricketMentoringVids" },
          ...
          { id: "b9", title: "Power Hitting Masterclass", description: "Learn to clear the boundary with clean bat swing, strong base, and explosive hip rotation for T20 cricket.", category: "batting" as const, skill: "Power Hitting", level: "advanced" as const, duration: "10 min", videoUrl: "https://www.youtube.com/watch?v=4jWQP1bEVGk", channel: "CoachCricXI" },
          { id: "b10", title: "Cut Shot Tutorial", description: "Master the square cut and late cut against short and wide deliveries with proper footwork and timing.", category: "batting" as const, skill: "Cut Shot", level: "intermediate" as const, duration: "6 min", videoUrl: "https://www.youtube.com/watch?v=0iBKydmXzUg", channel: "CoachCricXI" },
          ...
          { id: "w3", title: "Leg Spin Bowling Basics", description: "Learn leg spin fundamentals including grip, wrist position, release and flight control from Shane Warne's method.", category: "bowling" as const, skill: "Spin", level: "beginner" as const, duration: "10 min", videoUrl: "https://www.youtube.com/watch?v=o8kzlHe6Dxo", channel: "Cricket Mentoring" },
