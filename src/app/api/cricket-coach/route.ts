...
const FALLBACK_KNOWLEDGE: { keywords: string[]; response: string }[] = [
  ...
  {
    keywords: ["bowling action", "bowling", "action", "bowl"],
  ...
  {
    keywords: ["fielding", "catch", "catching", "ground fielding"],
  ...
  {
    keywords: ["fitness", "exercise", "conditioning", "strength", "speed"],
  ...
  {
    keywords: ["bat speed", "power", "hitting", "six", "boundary"],
  ...
  {
    keywords: ["wicketkeeping", "keeper", "keeping", "stance"],
  ...
  {
    keywords: ["mental", "pressure", "concentration", "nervous", "confidence"],
