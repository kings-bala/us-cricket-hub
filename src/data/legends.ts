...
export const legends: Legend[] = [
  ...
  { id: "l10", name: "Adam Gilchrist", country: "Australia", era: "1996–2008", skills: ["Wicket-Keeping", "Batting"], highlights: "Explosive keeper-batsman, 379 dismissals", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Adam_Gilchrist_of_Australia_%28cropped%29.jpg/200px-Adam_Gilchrist_of_Australia_%28cropped%29.jpg", routines: {
    ...
    Batting: [
      ...
      { name: "Power Clean Hitting", duration: "25 min", frequency: "4x/week", description: "Hit through the line with a straight bat, focusing on timing over brute force for clean striking", videoUrl: "https://www.youtube.com/watch?v=4jWQP1bEVGk" },
    ],
  }},
  ...
  { id: "l14", name: "Jacques Kallis", country: "South Africa", era: "1995–2014", skills: ["Batting", "Bowling", "Fielding"], highlights: "13,289 Test runs + 292 wickets, ultimate all-rounder", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Jacques_Kallis_6.jpg/200px-Jacques_Kallis_6.jpg", routines: {
    ...
    Bowling: [
      { name: "Medium-Pace Seam", duration: "30 min", frequency: "4x/week", description: "Practice hitting the seam consistently at 130-135 km/h with late movement", videoUrl: "https://www.youtube.com/watch?v=oa_wN1JqlKA" },
      { name: "Swing Bowling", duration: "25 min", frequency: "3x/week", description: "Work on out-swing and in-swing with wrist position variations", videoUrl: "https://www.youtube.com/watch?v=oa_wN1JqlKA" },
    ],
    Fielding: [
  ...
  { id: "l16", name: "Imran Khan", country: "Pakistan", era: "1971–1992", skills: ["Batting", "Bowling"], highlights: "3,807 Test runs + 362 wickets, 1992 World Cup winner", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Prime_Minister_Imran_Khan_Adresses_the_Forum_01.jpg/200px-Prime_Minister_Imran_Khan_Adresses_the_Forum_01.jpg", routines: {
    ...
    Bowling: [
      { name: "Pace & Bounce", duration: "40 min", frequency: "5x/week", description: "Bowl with full effort to generate pace and steep bounce from a high action point", videoUrl: "https://www.youtube.com/watch?v=SH3vf2JsBVE" },
      { name: "Reverse Swing Setup", duration: "30 min", frequency: "4x/week", description: "Practice maintaining the ball for reverse swing and executing late movement at pace", videoUrl: "https://www.youtube.com/watch?v=oa_wN1JqlKA" },
    ],
  }},
  ...
  { id: "l19", name: "Dale Steyn", country: "South Africa", era: "2004–2021", skills: ["Bowling"], highlights: "439 Test wickets, fastest to 400 Test wickets", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Dale_Steyn_YM.jpg/200px-Dale_Steyn_YM.jpg", routines: {
    Bowling: [
      { name: "Express Pace Drills", duration: "40 min", frequency: "5x/week", description: "Full-effort bowling focusing on run-up rhythm, explosive delivery stride, and pace above 145 km/h", videoUrl: "https://www.youtube.com/watch?v=SH3vf2JsBVE" },
      { name: "Outswing Mastery", duration: "30 min", frequency: "Daily", description: "Practice late outswing with upright seam — aim to move the ball after it passes the batsman", videoUrl: "https://www.youtube.com/watch?v=oa_wN1JqlKA" },
  ...
  { id: "l20", name: "Jeff Thomson", country: "Australia", era: "1972–1985", skills: ["Bowling"], highlights: "Fastest bowler in history, 200 Test wickets", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/LILLEE_AND_THOMSON_%282877049442%29.jpg/200px-LILLEE_AND_THOMSON_%282877049442%29.jpg", routines: {
    Bowling: [
      { name: "Slingshot Action Drill", duration: "30 min", frequency: "5x/week", description: "Practice the unique slingshot bowling action for maximum pace generation", videoUrl: "https://www.youtube.com/watch?v=SH3vf2JsBVE" },
  ...
  { id: "l22", name: "Rohit Sharma", country: "India", era: "2007–present", skills: ["Batting"], highlights: "3 ODI double centuries, Hitman, T20 World Cup-winning captain", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Rohit_Sharma_India_cricket_captain.jpg/200px-Rohit_Sharma_India_cricket_captain.jpg", routines: {
    Batting: [
      ...
      { name: "Powerplay Domination", duration: "30 min", frequency: "4x/week", description: "Simulate opening in powerplay overs — target boundaries through gaps with field restrictions", videoUrl: "https://www.youtube.com/watch?v=4jWQP1bEVGk" },
    ],
  }},
  { id: "l23", name: "Jasprit Bumrah", country: "India", era: "2016–present", skills: ["Bowling"], highlights: "Unorthodox action, death-overs specialist, #1 ICC Test bowler", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Jasprit_Bumrah_at_Wankhede_Stadium%2C_Nov_2024.jpg/200px-Jasprit_Bumrah_at_Wankhede_Stadium%2C_Nov_2024.jpg", routines: {
    Bowling: [
      { name: "Yorker Factory", duration: "40 min", frequency: "Daily", description: "Bowl 50+ yorkers targeting the base of stumps and blockhole — aim for 80% accuracy", videoUrl: "https://www.youtube.com/watch?v=r8R1QqjpXJE" },
      { name: "Short Run-Up Pace", duration: "30 min", frequency: "5x/week", description: "Generate 140+ km/h from a short run-up — focus on explosive delivery stride and hip drive", videoUrl: "https://www.youtube.com/watch?v=SH3vf2JsBVE" },
      { name: "Variation Mastery", duration: "35 min", frequency: "4x/week", description: "Practice slower balls, knuckle balls, wide yorkers, and bouncers with the same action", videoUrl: "https://www.youtube.com/watch?v=r8R1QqjpXJE" },
  ...
  { id: "l27", name: "Ben Stokes", country: "England", era: "2011–present", skills: ["Batting", "Bowling"], highlights: "Headingley 135*, World Cup 2019 hero, fearless match-winner", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Ben_Stokes_in_2019_%28cropped%29.jpg/200px-Ben_Stokes_in_2019_%28cropped%29.jpg", routines: {
    Batting: [
      { name: "Pressure Hitting", duration: "40 min", frequency: "5x/week", description: "Simulate match-winning scenarios — 30 off 20, 15 off 6 — practice calculated aggression under pressure", videoUrl: "https://www.youtube.com/watch?v=4jWQP1bEVGk" },
      { name: "Six-Hitting Drills", duration: "30 min", frequency: "4x/week", description: "Practice clearing the boundary against pace and spin — target specific zones", videoUrl: "https://www.youtube.com/watch?v=4jWQP1bEVGk" },
    ],
    Bowling: [
      { name: "Wicket-Taking Spells", duration: "30 min", frequency: "4x/week", description: "Practice bowling aggressive short spells of 4-5 overs at high intensity to break partnerships", videoUrl: "https://www.youtube.com/watch?v=oa_wN1JqlKA" },
      { name: "Reverse Swing at Pace", duration: "25 min", frequency: "3x/week", description: "Bowl with the old ball and generate reverse swing at 130-140 km/h", videoUrl: "https://www.youtube.com/watch?v=oa_wN1JqlKA" },
    ],
  }},
  { id: "l28", name: "Rashid Khan", country: "Afghanistan", era: "2015–present", skills: ["Bowling"], highlights: "Youngest Test captain, 500+ T20 wickets, leg-spin wizard", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Rashid_Khan_2021.jpg/200px-Rashid_Khan_2021.jpg", routines: {
    Bowling: [
      { name: "Rapid Leg-Spin", duration: "40 min", frequency: "Daily", description: "Bowl leg-breaks, googlies, and flippers at speed — minimize flight time to rush batsmen", videoUrl: "https://www.youtube.com/watch?v=o8kzlHe6Dxo" },
      { name: "Googly Disguise", duration: "30 min", frequency: "5x/week", description: "Practice bowling the googly with identical action to the leg-break — focus on wrist position", videoUrl: "https://www.youtube.com/watch?v=o8kzlHe6Dxo" },
  ...
  { id: "l29", name: "Suryakumar Yadav", country: "India", era: "2021–present", skills: ["Batting"], highlights: "T20I #1 batter, 360-degree modern striker, 4 T20I centuries", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Suryakumar_Yadav_2023.jpg/200px-Suryakumar_Yadav_2023.jpg", routines: {
    Batting: [
      ...
      { name: "Intent From Ball One", duration: "30 min", frequency: "5x/week", description: "Practice attacking the first ball of the innings — build the fearless T20 mentality", videoUrl: "https://www.youtube.com/watch?v=4jWQP1bEVGk" },
  ...
  { id: "l30", name: "Kagiso Rabada", country: "South Africa", era: "2014–present", skills: ["Bowling"], highlights: "300+ international wickets, aggressive fast bowler, ICC #1 ranked", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Kagiso_Rabada_2018_%28cropped%29.jpg/200px-Kagiso_Rabada_2018_%28cropped%29.jpg", routines: {
    Bowling: [
      { name: "Aggressive Pace Spells", duration: "40 min", frequency: "5x/week", description: "Bowl hostile 5-over spells at 145+ km/h — practice maintaining pace late in the day", videoUrl: "https://www.youtube.com/watch?v=SH3vf2JsBVE" },
      { name: "Nip-Backer Delivery", duration: "30 min", frequency: "Daily", description: "Practice the ball that nips back into right-handers off the seam at pace — LBW weapon", videoUrl: "https://www.youtube.com/watch?v=oa_wN1JqlKA" },
      { name: "Death Overs Execution", duration: "30 min", frequency: "4x/week", description: "Bowl yorkers and slower bouncers in the last 5 overs under scoreboard pressure", videoUrl: "https://www.youtube.com/watch?v=r8R1QqjpXJE" },
    ],
  }},
  { id: "l31", name: "Rishabh Pant", country: "India", era: "2017–present", skills: ["Wicket-Keeping", "Batting"], highlights: "Fearless keeper-batter, match-winning centuries in Aus & Eng, T20 destroyer", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Rishabh_Pant_%282%29.jpg/200px-Rishabh_Pant_%282%29.jpg", routines: {
    ...
    Batting: [
      { name: "Fearless Counter-Attack", duration: "40 min", frequency: "5x/week", description: "Practice attacking in tough situations — score against the new ball, reverse sweep spinners in Tests", videoUrl: "https://www.youtube.com/watch?v=4jWQP1bEVGk" },
  ...
  { id: "l33", name: "Shaheen Shah Afridi", country: "Pakistan", era: "2018–present", skills: ["Bowling"], highlights: "Left-arm fast, 100+ Test wickets, deadly with the new ball", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Shaheen_Shah_Afridi_2022.jpg/200px-Shaheen_Shah_Afridi_2022.jpg", routines: {
    Bowling: [
      { name: "Left-Arm Angle Attack", duration: "40 min", frequency: "Daily", description: "Exploit the natural angle into right-handers — target the stumps and LBW zone consistently", videoUrl: "https://www.youtube.com/watch?v=SH3vf2JsBVE" },
      { name: "New Ball Swing", duration: "30 min", frequency: "5x/week", description: "Bowl with the new ball and generate late inswing to right-handers at 145+ km/h", videoUrl: "https://www.youtube.com/watch?v=oa_wN1JqlKA" },
      { name: "Powerplay Wickets", duration: "30 min", frequency: "4x/week", description: "Practice bowling in powerplay overs — mix full, short, and wide yorkers to take early wickets", videoUrl: "https://www.youtube.com/watch?v=r8R1QqjpXJE" },
    ],
  }},
  { id: "l34", name: "Mitchell Starc", country: "Australia", era: "2010–present", skills: ["Bowling"], highlights: "Left-arm thunderbolt, World Cup specialist, 300+ Test wickets", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/Mitchell_Starc_bowling%2C_2021.jpg/200px-Mitchell_Starc_bowling%2C_2021.jpg", routines: {
    Bowling: [
      { name: "Inswing Yorker", duration: "40 min", frequency: "Daily", description: "Master the devastating inswinging yorker to right-handers — the signature World Cup delivery", videoUrl: "https://www.youtube.com/watch?v=r8R1QqjpXJE" },
      { name: "Raw Pace Generation", duration: "35 min", frequency: "5x/week", description: "Full-effort deliveries at 150+ km/h — focus on run-up rhythm and explosive front-arm pull", videoUrl: "https://www.youtube.com/watch?v=SH3vf2JsBVE" },
      { name: "White Ball Mastery", duration: "30 min", frequency: "4x/week", description: "Practice bowling with the white ball — exploit swing in the first 10 and last 10 overs", videoUrl: "https://www.youtube.com/watch?v=oa_wN1JqlKA" },
    ],
  }},
  { id: "l35", name: "Travis Head", country: "Australia", era: "2018–present", skills: ["Batting"], highlights: "Ashes hero, World Cup final century, aggressive left-hand batter", photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Travis_Head_2023.jpg/200px-Travis_Head_2023.jpg", routines: {
    Batting: [
      { name: "Counter-Attack Mode", duration: "40 min", frequency: "5x/week", description: "Practice attacking from the first ball — back yourself to hit boundaries when bowlers err in length", videoUrl: "https://www.youtube.com/watch?v=4jWQP1bEVGk" },
