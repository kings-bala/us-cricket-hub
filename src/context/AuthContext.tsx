...
const SEED_ACCOUNTS: { email: string; password: string; user: AuthUser }[] = [
  ...
  { email: "mandar@risingstar.com", password: "coach123", user: { email: "mandar@risingstar.com", name: "Coach Mandar", role: "coach", academyId: "academy_risingstar" } },
  { email: "vraj@risingstar.com", password: "coach123", user: { email: "vraj@risingstar.com", name: "Coach Vraj", role: "coach", academyId: "academy_risingstar" } },
